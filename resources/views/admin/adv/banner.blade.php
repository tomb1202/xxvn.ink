                        ...
                        @if (!empty($data))
                            @foreach ($data as $key => $item)
                                <tr class="tr-{{ $item->id }}">
                                    ...
                                    <td><a href="{{ $item->link }}" href="_blank">{!! Str::words($item->link, 10, '....') !!}</a></td>
                        ...
                        <div class="col-md-4">
                            <div class="form-group clearfix">
                                ...
                                <select name="position[]" class="select2" multiple>
                                    ...
                                    <option value="sidebar_left">Bên trái</option>
                                    <option value="sidebar_right">Bên phải</option>
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group clearfix">
                                        ...
                                        <select name="position[]" class="select2" multiple required>
                                            ...
                                            <option value="sidebar_left" {{ in_array('sidebar_left', $positions) ? 'selected' : '' }}>Bên trái</option>
                                            <option value="sidebar_right" {{ in_array('sidebar_right', $positions) ? 'selected' : '' }}>Bên phải</option>
