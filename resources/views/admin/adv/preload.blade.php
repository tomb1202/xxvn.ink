        ...
        <form class="modal-content" id="formData_add" method="POST" action="{{ route('admin.adv.store') }}"
            ...
            <div class="modal-body">
                ...
                <div class="form-group clearfix">
                    ...
                    <input name="link" type="link" required class="form-control" placeholder="https://bet88.com" autocomplete="off">
                </div>

                <div class="form-group clearfix">
                    <label class="control-label">Liên kết phụ:</label>
                    <input name="other_link" type="other_link" class="form-control" placeholder="https://bet88.com" autocomplete="off">
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <form class="modal-content" method="POST" action="{{ route('admin.adv.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group clearfix">
                            <label class="control-label">Liên kết phụ:</label>
                            <input name="other_link" type="other_link" value="{{ $item->other_link }}" class="form-control"
                                placeholder="https://bet88.com" autocomplete="off">
                        </div>
